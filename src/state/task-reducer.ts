...
export const changeTaskStatusAC = ( id: string, task: TaskType, todoId: string,) => {
    return {
...
export const updateTasksThunkCreator = (todolistId: string, taskId: string, status: TaskStatuses) => {
